...
struct MyPageView: View {
    ...
    @State private var isShownNickName: Bool = false
    ...
    // MARK: - 유저 버튼
                VStack{
                    ...
                    .sheet(isPresented: $isShownNickName){
                        EditUserView(isShownNickName: $isShownNickName)
    ...
    func calculateStamp(myWordNotes: [WordNote]) -> Int{
        ...
        for wordNote in myWordNotes{
            if wordNote.repeatCount == 4{
                count += 1
            }
        }
        return count
