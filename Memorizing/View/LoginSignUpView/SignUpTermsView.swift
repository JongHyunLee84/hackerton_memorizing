                ...
                ScrollView{
                    VStack(alignment: .leading, spacing: 20){
                        ...
                        Text("제 1조 (목적)")
                            ...
                            .fontWeight(.bold)
                        HStack{
                            Text("이 약관은 MEMOrizing(이하 ") + Text("\"최우수작\"").fontWeight(.bold).font(.title2).foregroundColor(.blue) + Text("이라 한다.)이 제공하는 단어장 서비스의 이용 조건 및 절차, 이용자와 ")
...
+ Text("의 권리, 의무, 책임 사항과 기타 필요한 사항을 규정하기 위한 것입니다. 이 약관이 적용되는 앱의 내용은 다음과 같습니다.")
                        ...
                        Text("⑤ 회원 정보: 필명, 계정(ID), 비밀번호, 전자 우편(이메일, E-mail) 등 MEMOrizing의 회원 가입 신청서 양식 등에 기재를 요청하는 회원의 개인 정보를 말합니다.")
...
struct SignUpTermsView_Previews: PreviewProvider {
    static var previews: some View {
        SignUpTermsView(termsAgreed: .constant(false))
    }
}
