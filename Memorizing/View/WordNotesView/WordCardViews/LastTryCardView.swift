...
//        } else {
            VStack {
                ...
                LevelCheckForLast(isShowingModal: $isShowingModal, isFlipped: $isFlipped, isDismiss: $isDismiss, totalScore: $totalScore, lastWordIndex: wordCount, num: $num, wordNote: myWordNote, word: word[num])
                    .padding(.top)
